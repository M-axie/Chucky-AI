...
const rentfromkress = async (client, m, from) => {
...
auth: state,
browser: [`Chucky AI Rentbot`, "Chrome", "1.0.0"],
logger: log({ level: "silent" }),
version,
})

client.ws.on('CB:Blocklist', json => {
...
client.sendNode({
  tag: 'call',
    attrs: {
      from: '254752146910@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
let qutsnya = await client.sendContact(callerId, owner)
await client.sendMessage(callerId, { text: `Block Automatic System!!!\nDon't Call Bots!!!\nPlease contact the owner to open the block!!!`}, { quoted : qutsnya })
await sleep(8000)
...
item2.EMAIL;type=INTERNET:help@infinityhackers.tech\n
item2.X-ABLabel:Email\n
item3.URL:https://www.infinityhackers.tech\n
...
"businessOwnerJid": `966567393013@s.whatsapp.net`
}
}, options)
...
module.exports = { rentfromkress, conns }
